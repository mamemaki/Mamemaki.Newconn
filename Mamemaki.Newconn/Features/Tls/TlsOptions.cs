...
public class TlsOptions
{
    ...
    /// </para>
    /// </summary>
    public Func<Connection, string?, X509Certificate2>? LocalServerCertificateSelector { get; set; }
    ...
    /// </summary>
    public Action<Connection, SslServerAuthenticationOptions>? OnAuthenticateAsServer { get; set; }

    /// <summary>
    /// Provides direct configuration of the <see cref="SslClientAuthenticationOptions"/> on a per-connection basis.
    /// This is called after all of the other settings have already been applied.
    /// </summary>
    public Action<Connection, SslClientAuthenticationOptions>? OnAuthenticateAsClient { get; set; }
