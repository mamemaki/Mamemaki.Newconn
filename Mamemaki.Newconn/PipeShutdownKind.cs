...
public enum PipeShutdownKind
{
    ...
    ReadSocketError = 104,
    /// <summary>
    /// The socket-reader encountered a socket reset - the SocketError may be populated
    /// </summary>
    ReadSocketReset = 105,
    /// <summary>
    /// The socket-reader encountered a socket abort - the SocketError may be populated
    /// </summary>
    ReadSocketAborted = 106,
    /// <summary>
    /// When attempting to flush incoming data, the pipe indicated that it was complete
    /// </summary>
    ReadFlushCompleted = 107,
    /// <summary>
    /// When attempting to flush incoming data, the pipe indicated cancelation
    /// </summary>
    ReadFlushCanceled = 108,
    ...
    /// <summary>
    /// The socket-writer encountered a socket reset - the SocketError may be populated
    /// </summary>
    WriteSocketReset = 206,
    /// <summary>
    /// The socket-writer encountered a socket abort - the SocketError may be populated
    /// </summary>
    WriteSocketAborted = 207,
    ...
    /// <summary>
    /// The output's writer was completed
    /// </summary>
